      ...
      >
        ...
        <div className="p-3 sm:p-4 flex flex-col flex-1">
          ...
          <div className="mt-4">
            {quantity === 0 ? (
              <button
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 rounded-lg transition text-sm sm:text-base"
                onClick={(e) => {
                  e.stopPropagation();
                  addToCart({
                    id,
              ...
              <div className="w-full flex items-center justify-between bg-blue-600 rounded-lg overflow-hidden shadow">
                <button
